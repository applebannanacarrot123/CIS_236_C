...
int main(void)
{
   int a[SIZE] = { 1, 4, 2, 9, 5 }; // initialize array a
   ...
   modifyArray(a, SIZE); // passes array a to modifyArray by "reference"
   ...
   modifyElement(a[3]); // passes array element a[3] by value
